...
def part_process(g, top=1000):
    ...
    for year in range(2013, 2014):
        ...
        # dgl.save_graphs(f"save/coauthor_{year}.graph", [coauthor])
        dgl.save_graphs(f"/home/ztl/save/coauthor_{year}.graph", [coauthor])
        coauthors.append(coauthor)
    # dgl.save_graphs("save/coauthors.graph", coauthors)
    return coauthors
